        ...
        <Navbar className="z-50 mx-auto border-none bg-darkgray-100 px-8 py-4">
            <div className="mx-auto flex items-center justify-between">
                <div className="flex flex-row items-center justify-between gap-4 self-start">
                    ...
                    <Button
                        ripple={true}
                        className="!border !border-sepia-100 !bg-opacity-0 !text-lg !font-semibold text-sepia-200"
                ...
                {Object.keys(context.userData).length > 0 ? (
                    <div className="flex flex-row gap-6 self-end">
                        <span className="flex items-center justify-center !text-md !font-light text-sepia-200">
